...
object AppUpdater {
    ...
    /** Returns the APK download URL from the latest GitHub Release, or null on failure. */
    ...
    /**
     * Downloads the APK from [apkUrl] to the app's cache dir.
     * Calls [onProgress] with values 0–100. Returns the local File, or null on failure.
     */
